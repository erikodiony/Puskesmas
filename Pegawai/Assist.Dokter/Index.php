	...
	<div class="panel panel-default">
		<div class="panel-heading" role="tab" id="headingOne">
			<h4 class="panel-title">
				...
				<span class="glyphicon glyphicon-eye-open"></span> Pantauan Poli Gigi (Pemeriksaan Pasien)</a> 
			</h4>
			</div>
				...
				<div class="panel-body">
				  ...
				  <?php 
					  mysql_connect('localhost','root',''); 
					  mysql_select_db('puskesmas'); 
					  $tampil="SELECT pasien.id_pasien, `jam_masuk`, `tgl_masuk`, `1_Edit`, `2_Dokter`
					FROM proses, pasien WHERE proses.id_pasien=pasien.id_pasien AND `1_Edit` = 'Tuntas' AND `2_Dokter` = 'Proses' AND `r_rawat` = 'Poli Gigi'
	...
	<div class="panel panel-default">
		<div class="panel-heading" role="tab" id="headingTwo">
			<h4 class="panel-title">
				...
				<span class="glyphicon glyphicon-eye-open"></span> Pantauan Poli Kesehatan Ibu Anak (Pemeriksaan Pasien)</a> 
			</h4>
			</div>
				...
				<div class="panel-body">
				  ...
				  <?php 
					...
					FROM proses, pasien WHERE proses.id_pasien=pasien.id_pasien AND `1_Edit` = 'Tuntas' AND `2_Dokter` = 'Proses' AND `r_rawat` = 'Poli Kesehatan Ibu Anak'
					ORDER BY pasien.id_pasien;"; 
					  $qryTampil=mysql_query($tampil); 
					  while ($dataTampil=mysql_fetch_array($qryTampil)) { 
				  ?> 
	...
	<div class="panel panel-default">
		<div class="panel-heading" role="tab" id="headingThree">
			<h4 class="panel-title">
				...
				<span class="glyphicon glyphicon-eye-open"></span> Pantauan Poli Mata (Pemeriksaan Pasien)</a> 
			</h4>
			</div>
				...
				<div class="panel-body">
				  ...
				  <?php 
					  ...
					  mysql_select_db('puskesmas'); 
					  $tampil="SELECT pasien.id_pasien, `jam_masuk`, `tgl_masuk`, `1_Edit`, `2_Dokter`
					FROM proses, pasien WHERE proses.id_pasien=pasien.id_pasien AND `1_Edit` = 'Tuntas' AND `2_Dokter` = 'Proses' AND `r_rawat` = 'Poli Mata'
					ORDER BY pasien.id_pasien;"; 
					  $qryTampil=mysql_query($tampil); 
					  while ($dataTampil=mysql_fetch_array($qryTampil)) { 
				  ?> 
	...
	<div class="panel panel-default">
		<div class="panel-heading" role="tab" id="headingFour">
			<h4 class="panel-title">
				...
				<span class="glyphicon glyphicon-eye-open"></span> Pantauan Poli THT (Pemeriksaan Pasien)</a> 
			</h4>
			</div>
				...
				<div class="panel-body">
				  ...
				  <?php 
					  ...
					  mysql_select_db('puskesmas'); 
					  $tampil="SELECT pasien.id_pasien, `jam_masuk`, `tgl_masuk`, `1_Edit`, `2_Dokter`
					FROM proses, pasien WHERE proses.id_pasien=pasien.id_pasien AND `1_Edit` = 'Tuntas' AND `2_Dokter` = 'Proses' AND `r_rawat` = 'Poli THT'
					ORDER BY pasien.id_pasien;"; 
					  $qryTampil=mysql_query($tampil); 
					  while ($dataTampil=mysql_fetch_array($qryTampil)) { 
				  ?> 
	...
	<div class="panel panel-default">
		<div class="panel-heading" role="tab" id="headingFive">
			<h4 class="panel-title">
				...
				<span class="glyphicon glyphicon-eye-open"></span> Pantauan Poli Umum (Pemeriksaan Pasien)</a> 
			</h4>
			</div>
				...
				<div class="panel-body">
				  ...
				  <?php 
					  ...
					  mysql_select_db('puskesmas'); 
					  $tampil="SELECT pasien.id_pasien, `jam_masuk`, `tgl_masuk`, `1_Edit`, `2_Dokter`
					FROM proses, pasien WHERE proses.id_pasien=pasien.id_pasien AND `1_Edit` = 'Tuntas' AND `2_Dokter` = 'Proses' AND `r_rawat` = 'Poli Umum'
					ORDER BY pasien.id_pasien;"; 
					  $qryTampil=mysql_query($tampil); 
					  while ($dataTampil=mysql_fetch_array($qryTampil)) { 
				  ?> 
